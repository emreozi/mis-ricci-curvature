...
"Discrete Ricci Curvature on Complex Network Topologies: An Application to
...
def main():
    ...
    o = OllivierRicci(G, alpha=ALPHA, method="OTD", proc=1, verbose="ERROR"); o.compute_ricci_curvature()
    ...
    ax.axis("off"); plt.tight_layout(); plt.savefig("mis_network.png", dpi=320, bbox_inches="tight"); plt.close()
    ...
    plt.tight_layout(); plt.savefig("mis_curv_vs_btw.png", dpi=320, bbox_inches="tight"); plt.close()
